...
const Main = () => {
  ...
  data.map((e,index) => {
    ...
    options.push({palletID : e.palletID, palletDateCreation:e.palletDateCreation, zoneDesignation: e.zoneDesignation , palletState : e.palletState,palletCreator:e.palletCreator}); }
